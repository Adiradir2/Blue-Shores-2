...
(function () {
  ...
  var SRC = [
    { h: L('עיריית הרצליה — מצגת הסכם הגג 2026', 'Herzliya Municipality — agreement deck 2026'), d: L('מקור רשמי · 14,100 יח"ד · 5 מיליארד ₪ · תשתיות', 'Official · 14,100 units · ₪5B · infrastructure'), u: "https://www.herzliya.muni.il/uploads/n/1774261436.8977.pdf", gov: true },
    { h: L('עיריית הרצליה — שאלות ותשובות', 'Herzliya Municipality — Q&A'), d: L('רשמי · היתרים 2029 · ראש סדר עדיפויות · רק"ל 2030-2033', 'Official · permits 2029 · top priority · LRT 2030-2033'), u: "https://www.herzliya.muni.il/uploads/n/1774261366.6452.pdf", gov: true },
    ...
    { h: L('מנהל התכנון — הר/2200/א׳', 'Planning Administration — Har/2200/A'), d: L('התוכנית הרשמית במבא"ת · 504-0396994', 'Official plan · 504-0396994'), u: "https://mavat.iplan.gov.il/SV4/1/5000399529/310", gov: true },
    ...
    { h: L('נת"ע — הקו הירוק', 'NTA — the Green Line'), d: L('39 ק"מ · 62 תחנות · הרצליה↔ת"א · מקטע דרומי 2028', '39 km · 62 stations · Herzliya↔TA · southern segment 2028'), u: "https://www.nta.co.il/light-rail/%D7%94%D7%A7%D7%95-%D7%94%D7%99%D7%A8%D7%95%D7%A7/", gov: true },
    { h: L('תת"ל/71/ג — תקנון (PDF)', 'NTP/71/C — regulations (PDF)'), d: L('תוכנית לאומית מאושרת · הקו הירוק מקטע צפוני', 'Approved national plan · Green Line northern segment'), u: "https://apps.land.gov.il/IturTabotData/takanonim/Artzi/9509574.pdf", gov: true },
    { h: L('עיריית ת"א — רכבת קלה', 'Tel Aviv Municipality — light rail'), d: L('רשת מלאה ~2030 · נת"ע אחראית', 'Full network ~2030 · operated by NTA'), u: "https://www.tel-aviv.gov.il/Residents/Transportation/Pages/masstransporttrain.aspx", gov: true },
    { h: L('עיריית הרצליה — היטל השבחה', 'Herzliya Municipality — betterment levy'), d: L('עמוד רשמי + טפסים · תצהיר פטור 19(ג) · בירור חבות', 'Official page + forms · §19(c) exemption affidavit · liability check'), u: "http://handasa.herzliya.muni.il/Rishuy_bnia/Pages/hashbaha.aspx", gov: true },
